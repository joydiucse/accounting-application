                ...
                <nav class="flex-1 px-4 py-6 space-y-2 overflow-y-auto">
                    ...
                    @if(auth()->user()->canManage())
                        ...
                        <a href="{{ route('dollar-incomes.index') }}" 
                           class="flex items-center px-4 py-3 text-sm font-medium rounded-xl transition-all duration-200 {{ request()->routeIs('dollar-incomes.*') ? 'bg-emerald-50 text-emerald-700 border-r-4 border-emerald-700' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}">
                            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">

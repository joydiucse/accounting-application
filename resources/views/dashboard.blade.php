        ...
        <div class="bg-white rounded-2xl shadow-sm border border-slate-200">
            ...
            <div class="p-6">
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div>
                        <h4 class="text-md font-semibold text-slate-800 mb-4">Recent Dollar Incomes</h4>
                        <div class="space-y-3">
                            @forelse($recentDollarIncomes->take(3) as $income)
                                <div class="flex items-center justify-between p-3 bg-green-50 rounded-lg border border-green-200">
                                    <div class="flex items-center space-x-3">
                                        ...
                                        <div>
                                            <p class="font-medium text-slate-900">{{ $income->source }}</p>
                                            <p class="text-xs text-slate-600">{{ $income->date->format('M d, Y') }}</p>
                                        </div>
                                    </div>
                                    <div class="text-right">
                                        <p class="font-bold text-green-700">${{ number_format($income->amount_usd, 2) }}</p>
                                        <p class="text-xs text-slate-600">৳{{ number_format($income->amount_bdt, 2) }}</p>
                                    </div>
                                </div>
                            @empty
                                <div class="text-center py-4">
                                    <p class="text-slate-500 text-sm">No recent dollar incomes.</p>
                                </div>
                            @endforelse
                        </div>
                    </div>
                    ...
                    <div>
                        <h4 class="text-md font-semibold text-slate-800 mb-4">Recent Dollar Expenses</h4>
                        <div class="space-y-3">
                            @forelse($recentDollarExpenses->take(3) as $expense)
                                <div class="flex items-center justify-between p-3 bg-red-50 rounded-lg border border-red-200">
                                    <div class="flex items-center space-x-3">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-xs text-slate-600">{{ $expense->date->format('M d, Y') }}</p>
                                        </div>
                                    </div>
                                    <div class="text-right">
                                        <p class="font-bold text-red-700">${{ number_format($expense->amount_usd, 2) }}</p>
                                        <p class="text-xs text-slate-600">৳{{ number_format($expense->amount_bdt, 2) }}</p>
                                    </div>
                                </div>
                            @empty
                                <div class="text-center py-4">
                                    <p class="text-slate-500 text-sm">No recent dollar expenses.</p>
                                </div>
                            @endforelse
                        </div>
                    </div>
            ...
            <div class="p-6 border-b border-slate-200">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-sm text-slate-600">Recent BDT financial activities</p>
                    </div>

                ...
                <form method="POST" action="{{ route('expenses.update', $expense) }}">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="flex items-center">
                            <input type="checkbox" name="from_dollar" id="from_dollar" value="1" {{ old('from_dollar', $expense->from_dollar) ? 'checked' : '' }} class="h-4 w-4 text-red-600 focus:ring-red-500 border-gray-300 rounded">
